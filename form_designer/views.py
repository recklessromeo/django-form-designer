...
from form_designer.forms import DesignedForm, AngularValidationForm
...
def process_form(request, form_definition, extra_context={}, disable_redirection=False):
    ...
    form_success = False
    is_submit = False
    form_class = DesignedForm
    if form_definition.use_djangular:
        form_class = AngularValidationForm
